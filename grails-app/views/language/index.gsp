...
<body>
<a href="#list-language" class="skip" tabindex="-1"><g:message code="default.link.skip.label"
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="lastUpdated"
                              title="${message(code: 'language.lastUpdated.label', default: 'Last Updated')}"/>
        ...
        <g:each in="${languageInstanceList}" status="i" var="languageInstance">
            <tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
                ...
                <td><g:link action="show"
                            id="${languageInstance.id}">${fieldValue(bean: languageInstance, field: "name")}</g:link></td>
